"""Variational Bayesian Inference implementation for GMMs.
Taken from https://github.com/beginaid/GMM-EM-VB."""
...
class GMMVB:
    ...
    def gmm_pdf(self, X):
        ...
        Returns:
            Probability density function (numpy ndarray): Values of the mixed D-dimensional
            Gaussian distribution at N data whose size is (N, K).
        """
    ...
    def visualize(self, X):
        ...
        label_frequency_desc = [lab[0] for lab in Counter(labels).most_common()]  # (K)
